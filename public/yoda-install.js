...
(function(){
  ...
  st.textContent=
    ".yoda-install{display:flex;align-items:center;gap:5px;width:-moz-fit-content;width:fit-content;margin:10px 0 4px;padding:6px 15px;font-family:var(--fb,'Noto Sans TC',system-ui,sans-serif);font-size:12px;font-weight:700;letter-spacing:.02em;color:#fff;background:rgba(255,255,255,.18);-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.32);border-radius:9999px;text-decoration:none;box-shadow:0 4px 16px rgba(0,0,0,.20);white-space:nowrap;transition:background .15s,transform .15s;z-index:60;cursor:pointer}"
    +".yoda-install:hover{background:rgba(255,255,255,.26);transform:translateY(-1px)}"
